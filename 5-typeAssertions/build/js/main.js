...
let a = 'Hello'; // a type One
let b = a; // casting type from a more specific type to a less specific (now b type = TWO)
let c = a; // casting type from a less specific to a more specific. 
